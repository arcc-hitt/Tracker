...
const Navbar = () => {
    return (
        <div className='w-full h-[70px] fixed bottom-0 lg:relative xl:relative md:relative flex justify-center m-0 space-x-0 items-center bg-alt shadow-[0px -6px 12px 0px #1E1E1E40]'>
